...
// shows the wrestling ppvs in a table with the headers of Promotion, Title, Presentation Format and Media Format
...
const PPV = () => {
  return (
    <div className="flex flex-col items-center mx-auto bg-darkpurple">
            ...
            <div className="md:text-3xl sm: text-l text-bedazzle py-2 font-bold underline">Professional Wrestling Pay Per View Events</div>
      <div className="py-8">
