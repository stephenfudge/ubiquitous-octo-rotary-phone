...
// shows the wwe dvds/brds in a table with the headers of Promotion, Title, Presentation Format and Media Format
...
const WWE = () => {
  ...
  {/* header of page */}
  <div className="md:text-3xl sm: text-l text-bedazzle py-2 font-bold underline">Professional Wrestling WWE Content</div>    
       <div className="py-8">
